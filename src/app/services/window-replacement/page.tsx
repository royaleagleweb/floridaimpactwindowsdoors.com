...
export const metadata: Metadata = {
  title: "Window Replacement in South Florida | Upgrade to Impact Windows",
  description:
    "Full-service window replacement in Miami-Dade, Broward & Palm Beach County. Replace aging, damaged, or non-impact windows with modern hurricane-rated impact glass. Free estimates.",
};
