...
export const metadata: Metadata = {
  title: "Energy Efficient Impact Windows in South Florida | Low-E Glass & Argon Fill",
  description:
    "Save up to 30% on energy bills with energy efficient impact windows in Miami-Dade, Broward & Palm Beach County. Low-E coatings, argon gas, and solar heat reduction. Free estimates.",
};
