...
export const metadata: Metadata = {
  title: "Financing Options | 0% Interest & PACE Available | Florida Impact Windows & Doors",
  description:
    "Affordable financing for impact windows and doors in South Florida. $0 down, 0% interest, PACE financing, FPL rebates, and insurance discounts. Florida Impact Windows & Doors makes hurricane protection affordable.",
};
      ...
      <section className="py-20 bg-gradient-to-br from-sun-500 via-palm-600 to-ocean-700 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:+17865551234" className="inline-flex items-center gap-2 text-white font-semibold text-lg hover:text-sun-200 transition-colors">
