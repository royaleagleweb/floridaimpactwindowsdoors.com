...
export const metadata: Metadata = {
  title: "About Florida Impact Windows & Doors | South Florida Impact Window Experts",
  description:
    "Learn about Florida Impact Windows & Doors, South Florida's trusted impact window and door installation company. Over 15 years of experience, 5,000+ installations, and a commitment to protecting your home.",
};
