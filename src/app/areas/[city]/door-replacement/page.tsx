...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Professional door replacement in ${city.name}, Florida. Entry doors, sliding glass doors, French doors, patio doors, and garage doors for ${city.county} County homes. Free estimates from Florida Impact Windows & Doors. Call (786) 555-1234.`,
  };
}
