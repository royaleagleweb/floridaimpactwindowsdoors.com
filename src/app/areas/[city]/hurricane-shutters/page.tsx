...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Professional hurricane shutter installation in ${city.name}, Florida. Accordion, roll-down, and colonial shutters for ${city.county} County homes. Free estimates. Call (786) 555-1234.`,
  };
}
