...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Professional window replacement services in ${city.name}, Florida. Upgrade aging windows to modern impact-rated glass. Energy savings, security, and storm protection. Free estimates. Call (786) 555-1234.`,
  };
}
