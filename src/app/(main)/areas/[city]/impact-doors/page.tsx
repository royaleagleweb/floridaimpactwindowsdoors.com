...
export default async function CityImpactDoorsPage({ params }: PageProps) {
  ...
  const serviceSchema = { "@context": "https://schema.org", "@type": "Service", name: `Impact Door Installation in ${city.name}, FL`, description: `Professional impact door installation in ${city.name}, ${city.county} County, Florida.`, provider: { "@type": "HomeAndConstructionBusiness", name: "Florida Impact Windows & Doors", telephone: "+1-754-600-4876" }, areaServed: { "@type": "City", name: city.name, containedIn: { "@type": "State", name: "Florida" } }, serviceType: "Impact Door Installation" };
